...
DEFINES += PROGRAMCONFIGQTSO_LIBRARY

SOURCES += \
    programConfig.cpp \
    programConfigConsole.cpp

HEADERS += \
    crossPlatformMacros.hpp \
    programConfig.hpp \
    programConfigConsole.hpp
...
LIBS += -llogsinJSONQtso -lcryptoQtso \
    -ltextQtso -ltranslatorJSONQtso -lessentialQtso
